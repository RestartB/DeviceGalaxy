...
<div class="w-full">
  <div>
    <div
      class="flex h-fit w-full flex-col items-center justify-center gap-4 bg-linear-to-b from-[#35005E] to-[#100031] p-12 px-2 pb-6 text-white"
    >
  ...
  <div class="flex w-full max-w-480 flex-col items-center justify-center">
