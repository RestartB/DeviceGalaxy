...
<svelte:head>
  <title>DeviceGalaxy - Open Source</title>
</svelte:head>
...
<div class="w-full">
  ...
  <div class="flex w-full max-w-[1920px] flex-col items-center justify-center">
    <div class="flex max-w-7xl flex-col gap-4 p-8">
      <div>
        <h2 class="text-2xl font-bold">Source Code</h2>
        <p>
          <span translate="no">DeviceGalaxy</span> is fully open source on GitHub! You can view the code,
          run your own instance, or contribute to the project.
        </p>
        <a
          href="https://github.com/RestartB/DeviceGalaxy"
          class="mt-2 flex h-11 w-fit cursor-pointer items-center justify-center gap-2 rounded-full border-2 border-zinc-400 bg-zinc-100 px-4 py-2 font-bold text-nowrap transition-colors hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700"
          target="_blank"
          title="GitHub Repo"
        >
          <Github size="20" class="flex-shrink-0" />
          GitHub Repo
        </a>
      </div>

      <div>
        <h2 class="text-2xl font-bold">Key Dependencies</h2>
        <p>
          Without these projects, DeviceGalaxy would not be possible. They help provide the core
          functionality that makes the site function.
        </p>
        ...
        <ul class="mt-4 flex flex-col gap-4">
          ...
          <li>
            <a href="https://orm.drizzle.team" target="_blank" title="Drizzle ORM">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="64"
                height="64"
              ...
              <div>
                ...
                <p>
                  Drizzle is an ORM that lets me easily interface with DeviceGalaxy's SQL database.
                  By using Drizzle, I don't have to worry about writing manual SQL queries, escaping
                  strings, etc.
                </p>
              </div>
            </a>
          ...
          <li>
            <a href="https://www.better-auth.com" target="_blank" title="Better Auth">
              ...
              <div>
                ...
                <p>
                  Better Auth is an auth framework that lets me easily manage my own local auth. It
                  has built in support for encrypted and salted passwords, 2FA, Drizzle integration,
                  and more.
                </p>
              </div>
            </a>
          ...
          <li>
            <a href="https://lucide.dev" target="_blank" title="Lucide">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="64"
                height="64"
              ...
              <div>
                ...
                <p>
                  Lucide is an icon pack with over 1000 consistent icons, all of them available as
                  Svelte components. Nearly all of the icons in this project come from Lucide!
                </p>
              </div>
            </a>
          </li>
          ...
          <li>
            <a href="https://superforms.rocks" target="_blank" title="SuperForms">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="64"
                height="64"
          ...
          <li>
            <a
              href="https://github.com/RestartB/DeviceGalaxy/blob/master/package.json"
              target="_blank"
              title="All Other Dependencies"
            >
              <Plus size="64" class="flex-shrink-0" />
              <div>
                <h3 class="text-xl font-semibold">Every other dependency!</h3>
                <p>
                  DeviceGalaxy wouldn't be around without the many other dependencies that it uses.
                  To check out the full list, view the package.json file in the GitHub repo!
                </p>
              </div>
            </a>
          </li>
